...
The HTTP API uses an email-code flow for existing Cool Computers owners. New account creation is temporarily paused; new owners can [join the waitlist](https://www.cool.computer/#waitlist).
